...
internal enum Asset {
  ...
  internal enum Images {
    ...
    internal static let artists = ImageAsset(name: "artists")
    ...
    internal static let genres = ImageAsset(name: "genres")
    ...
    internal static let popcornLandscape = ImageAsset(name: "popcorn-landscape")
    internal static let popcorn = ImageAsset(name: "popcorn")
    internal static let search = ImageAsset(name: "search")
    internal static let starGray = ImageAsset(name: "star-gray")
    internal static let starYellow = ImageAsset(name: "star-yellow")
  }
}
